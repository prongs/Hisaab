define(["dojo/_base/declare", "dojo/_base/connect", "dojo/dom", "dojo/on", "dojo/dom-geometry", "dojo/_base/fx", "dojo/fx", "dojo/_base/array",
	...
	"dojo/text!./templates/MainViewWidget.html", "dojo/text!./templates/new_tab.html", 'hisaab/SavePlugin',
	"./TripContentPane", "dijit/layout/ContentPane", "dijit/layout/TabContainer", "dijit/layout/TabController", "dijit/layout/BorderContainer", "dijit/form/TextBox", "dijit/form/Textarea","dijit/layout/AccordionContainer",
	...
	function(declare, connect, dom, on, domGeom, base_fx, fx, array,
		...
		template, newTabTemplate, HisaabSavePlugin, TripContentPane){
		return declare("hisaab.MainViewWidget", [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
			...
			postCreate: function(){
				...
				connect.subscribe('dijit.Editor.getPlugin', null, function(obj){
                    ...
                    if(name == "hisaab.SavePlugin")
                    {
                        obj.plugin = new HisaabSavePlugin();
                    }
                });
			},
